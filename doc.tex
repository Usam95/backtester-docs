...
\captionsetup[lstlisting]{belowskip=10pt} % Adjust 12pt to your liking
\captionsetup[lstlisting]{aboveskip=10pt} % Adjust 12pt to your liking
...
\input{backtesting.tex}  % Overview of the main backtesting directory
